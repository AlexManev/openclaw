// Shared Claude CLI backend configuration constants and normalization helpers.
// Exported via openclaw/plugin-sdk/cli-backend for use by bundled plugins
// that build on top of the local Claude CLI backend (e.g. anthropic, claude-headless).
